...
class DepartmentTable(BaseModel, database.Model):
    """Table responsible for interacting with the department table in the database"""
    ...
    def __repr__(self):
        return '<DepartmentTable {}>'.format(self.name)
